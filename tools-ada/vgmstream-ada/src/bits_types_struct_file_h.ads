...
package bits_types_struct_FILE_h is
  ...
  -- High-order word is _IO_MAGIC; rest is flags.  
   type u_IO_FILE;
   subtype anon1189_array1198 is Interfaces.C.char_array (0 .. 0);
   subtype anon1189_array1203 is Interfaces.C.char_array (0 .. 19);
   type u_IO_FILE is record
      ...
      u_shortbuf : aliased anon1189_array1198;  -- /usr/include/bits/types/struct_FILE.h:79
      ...
      u_unused2 : aliased anon1189_array1203;  -- /usr/include/bits/types/struct_FILE.h:98
   end record
