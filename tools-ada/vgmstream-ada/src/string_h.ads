...
package string_h is
  ...
  -- Find the first occurrence of C in S.   
   function strchr (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/string.h:230
   with Import => True, 
        Convention => C, 
        External_Name => "strchr";

  -- Find the last occurrence of C in S.   
   function strrchr (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/string.h:257
   with Import => True, 
        Convention => C, 
  ...
  -- Find the first occurrence in S of any character in ACCEPT.   
   function strpbrk (uu_s : Interfaces.C.Strings.chars_ptr; uu_accept : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/string.h:307
   with Import => True, 
        Convention => C, 
        External_Name => "strpbrk";

  -- Find the first occurrence of NEEDLE in HAYSTACK.   
   function strstr (uu_haystack : Interfaces.C.Strings.chars_ptr; uu_needle : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/string.h:334
   with Import => True, 
        Convention => C, 
  ...
  --   ERRNUM.   
   ...
   function strerror_r
     (uu_errnum : int;
      ...
      uu_buflen : stddef_h.size_t) return int  -- /usr/include/string.h:416
   with Import => True, 
        Convention => C, 
