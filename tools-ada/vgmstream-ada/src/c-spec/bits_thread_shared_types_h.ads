...
package bits_thread_shared_types_h is
  ...
  -- Common definition of pthread_cond_t.  
   type anon993_struct995 is record
   ...
   type anon993_union994 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_wseq : aliased Extensions.unsigned_long_long;  -- /usr/include/bits/thread-shared-types.h:96
         when others =>
            uu_wseq32 : aliased anon993_struct995;  -- /usr/include/bits/thread-shared-types.h:101
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon993_struct997 is record
   ...
   with Convention => C_Pass_By_Copy;
   type anon993_union996 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_g1_start : aliased Extensions.unsigned_long_long;  -- /usr/include/bits/thread-shared-types.h:105
         when others =>
            uu_g1_start32 : aliased anon993_struct997;  -- /usr/include/bits/thread-shared-types.h:110
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon993_array998 is array (0 .. 1) of aliased unsigned;
   type uu_pthread_cond_s is record
      anon2180 : aliased anon993_union994;  -- /usr/include/bits/thread-shared-types.h:102
      anon2187 : aliased anon993_union996;  -- /usr/include/bits/thread-shared-types.h:111
      uu_g_refs : aliased anon993_array998;  -- /usr/include/bits/thread-shared-types.h:112
      uu_g_size : aliased anon993_array998;  -- /usr/include/bits/thread-shared-types.h:113
      ...
      uu_g_signals : aliased anon993_array998;  -- /usr/include/bits/thread-shared-types.h:116
   end record
