...
package stdlib_h is
  ...
  -- Current state.   
   type anon1075_array1063 is array (0 .. 2) of aliased unsigned_short;
   type drand48_data is record
      uu_x : aliased anon1075_array1063;  -- /usr/include/stdlib.h:492
      uu_old_x : aliased anon1075_array1063;  -- /usr/include/stdlib.h:493
  ...
  -- Free a block allocated by `malloc', `realloc' or `calloc'.   
   procedure free (uu_ptr : System.Address)  -- /usr/include/stdlib.h:554
   with Import => True, 
        Convention => C, 
        External_Name => "free";
  ...
  -- Add reallocarray as its own deallocator.   
   function reallocarray
     (uu_ptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:568
   with Import => True, 
        Convention => C, 
        External_Name => "reallocarray";

  -- Allocate SIZE bytes on a page boundary.  The storage cannot be freed.   
   function valloc (uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:579
   with Import => True, 
        Convention => C, 
  ...
  -- Allocate memory of SIZE bytes with an alignment of ALIGNMENT.   
   function posix_memalign
     (uu_memptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return int  -- /usr/include/stdlib.h:585
   with Import => True, 
        Convention => C, 
        External_Name => "posix_memalign";

  -- ISO C variant of aligned allocation.   
   function aligned_alloc (uu_alignment : stddef_h.size_t; uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:591
   with Import => True, 
        Convention => C, 
        External_Name => "aligned_alloc";

  -- Abort execution and generate a core-dump.   
   procedure c_abort  -- /usr/include/stdlib.h:596
   with Import => True, 
        Convention => C, 
        External_Name => "abort";

  -- Register a function to be called when `exit' is called.   
   function atexit (uu_func : access procedure) return int  -- /usr/include/stdlib.h:600
   with Import => True, 
        Convention => C, 
        External_Name => "atexit";

  -- Register a function to be called when `quick_exit' is called.   
   function at_quick_exit (uu_func : access procedure) return int  -- /usr/include/stdlib.h:608
   with Import => True, 
        Convention => C, 
  ...
  --   given to `exit' and the given argument.   
   ...
   function on_exit (uu_func : access procedure (arg1 : int; arg2 : System.Address); uu_arg : System.Address) return int  -- /usr/include/stdlib.h:615
   with Import => True, 
        Convention => C, 
  ...
  --   perform stdio cleanup, and terminate program execution with STATUS.   
   ...
   procedure c_exit (uu_status : int)  -- /usr/include/stdlib.h:622
   with Import => True, 
        Convention => C, 
        External_Name => "exit";
  ...
  --   execution with STATUS.   
   ...
   procedure quick_exit (uu_status : int)  -- /usr/include/stdlib.h:628
   with Import => True, 
        Convention => C, 
  ...
  -- Return the value of envariable NAME, or NULL if it doesn't exist.   
   function getenv (uu_name : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:639
   with Import => True, 
        Convention => C, 
  ...
  --   If there is no `=', remove NAME from the environment.   
   ...
   function putenv (uu_string : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/stdlib.h:652
   with Import => True, 
        Convention => C, 
  ...
  --   If REPLACE is nonzero, overwrite an existing value.   
   ...
   function setenv
     (uu_name : Interfaces.C.Strings.chars_ptr;
      ...
      uu_replace : int) return int  -- /usr/include/stdlib.h:658
   with Import => True, 
        Convention => C, 
        External_Name => "setenv";

  -- Remove the variable NAME from the environment.   
   function unsetenv (uu_name : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/stdlib.h:662
   with Import => True, 
        Convention => C, 
  ...
  --   for Fortran 77) requires this function.   
   ...
   function clearenv return int  -- /usr/include/stdlib.h:669
   with Import => True, 
        Convention => C, 
  ...
  --   string if it cannot get a unique file name.   
   ...
   function mktemp (uu_template : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:680
   with Import => True, 
        Convention => C, 
  ...
  --   marked with __THROW.   
   ...
   function mkstemp (uu_template : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/stdlib.h:693
   with Import => True, 
        Convention => C, 
  ...
  --   marked with __THROW.   
   ...
   function mkstemps (uu_template : Interfaces.C.Strings.chars_ptr; uu_suffixlen : int) return int  -- /usr/include/stdlib.h:715
   with Import => True, 
        Convention => C, 
  ...
  --   The directory is created mode 700.   
   ...
   function mkdtemp (uu_template : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:736
   with Import => True, 
        Convention => C, 
  ...
  --   __THROW.   
   ...
   function c_system (uu_command : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/stdlib.h:789
   with Import => True, 
        Convention => C, 
  ...
  --   returns the name in RESOLVED.   
   ...
   function realpath (uu_name : Interfaces.C.Strings.chars_ptr; uu_resolved : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:806
   with Import => True, 
        Convention => C, 
  ...
  -- Shorthand for type of comparison functions.   
   ...
   with Convention => C;  -- /usr/include/stdlib.h:814
  ...
  --   of SIZE bytes each, using COMPAR to perform the comparisons.   
   ...
   function bsearch
     (uu_key : System.Address;
      ...
      uu_compar : uu_compar_fn_t) return System.Address  -- /usr/include/stdlib.h:826
   with Import => True, 
        Convention => C, 
  ...
  --   using COMPAR to perform the comparisons.   
   ...
   procedure qsort
     (uu_base : System.Address;
      uu_nmemb : stddef_h.size_t;
      uu_size : stddef_h.size_t;
      uu_compar : uu_compar_fn_t)  -- /usr/include/stdlib.h:836
   with Import => True, 
        Convention => C, 
        External_Name => "qsort";

  -- Return the absolute value of X.   
   function c_abs (uu_x : int) return int  -- /usr/include/stdlib.h:846
   with Import => True, 
        Convention => C, 
        External_Name => "abs";

   function labs (uu_x : long) return long  -- /usr/include/stdlib.h:847
   with Import => True, 
        Convention => C, 
        External_Name => "labs";

   function llabs (uu_x : Long_Long_Integer) return Long_Long_Integer  -- /usr/include/stdlib.h:850
   with Import => True, 
        Convention => C, 
        External_Name => "llabs";
  ...
  -- GCC may have built-ins for these someday.   
   function div (uu_numer : int; uu_denom : int) return div_t  -- /usr/include/stdlib.h:858
   with Import => True, 
        Convention => C, 
        External_Name => "div";

   function ldiv (uu_numer : long; uu_denom : long) return ldiv_t  -- /usr/include/stdlib.h:860
   with Import => True, 
        Convention => C, 
        External_Name => "ldiv";

   function lldiv (uu_numer : Long_Long_Integer; uu_denom : Long_Long_Integer) return lldiv_t  -- /usr/include/stdlib.h:864
   with Import => True, 
        Convention => C, 
        External_Name => "lldiv";
  ...
  --   the number.   
   ...
   function fcvt
     (uu_value : double;
      uu_ndigit : int;
      uu_decpt : access int;
      uu_sign : access int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:884
   with Import => True, 
        Convention => C, 
        External_Name => "fcvt";
  ...
  --   be written to BUF.   
   ...
   function gcvt
     (uu_value : double;
      uu_ndigit : int;
      uu_buf : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:890
   with Import => True, 
        Convention => C, 
        External_Name => "gcvt";
  ...
  -- Long double versions of above functions.   
   function qecvt
     (uu_value : long_double;
      uu_ndigit : int;
      uu_decpt : access int;
      uu_sign : access int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:896
   with Import => True, 
        Convention => C, 
        External_Name => "qecvt";
   ...
   function qgcvt
     (uu_value : long_double;
      uu_ndigit : int;
      uu_buf : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/include/stdlib.h:902
   with Import => True, 
        Convention => C, 
        External_Name => "qgcvt";
  ...
  --   buffers.   
   ...
   function ecvt_r
     (uu_value : double;
      ...
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:908
   with Import => True, 
        Convention => C, 
   ...
   function fcvt_r
     (uu_value : double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:911
   with Import => True, 
        Convention => C, 
   ...
   function qecvt_r
     (uu_value : long_double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:915
   with Import => True, 
        Convention => C, 
   ...
   function qfcvt_r
     (uu_value : long_double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:919
   with Import => True, 
        Convention => C, 
  ...
  --   in S, which is no longer than N.   
   ...
   function mblen (uu_s : Interfaces.C.Strings.chars_ptr; uu_n : stddef_h.size_t) return int  -- /usr/include/stdlib.h:928
   with Import => True, 
        Convention => C, 
        External_Name => "mblen";
  ...
  --   putting its `wchar_t' representation in *PWC.   
   ...
   function mbtowc
     (uu_pwc : access stddef_h.wchar_t;
      ...
      uu_n : stddef_h.size_t) return int  -- /usr/include/stdlib.h:931
   with Import => True, 
        Convention => C, 
  ...
  --   by WCHAR in S, returning its length.   
   ...
   function wctomb (uu_s : Interfaces.C.Strings.chars_ptr; uu_wchar : stddef_h.wchar_t) return int  -- /usr/include/stdlib.h:935
   with Import => True, 
        Convention => C, 
  ...
  -- Convert a multibyte string to a wide char string.   
   function mbstowcs
     (uu_pwcs : access stddef_h.wchar_t;
      uu_s : Interfaces.C.Strings.chars_ptr;
      uu_n : stddef_h.size_t) return stddef_h.size_t  -- /usr/include/stdlib.h:939
   with Import => True, 
        Convention => C, 
  ...
  -- Convert a wide char string to multibyte string.   
   function wcstombs
     (uu_s : Interfaces.C.Strings.chars_ptr;
      uu_pwcs : access stddef_h.wchar_t;
      uu_n : stddef_h.size_t) return stddef_h.size_t  -- /usr/include/stdlib.h:943
   with Import => True, 
        Convention => C, 
  ...
  --   negative, and -1 if not matching.   
   ...
   function rpmatch (uu_response : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/stdlib.h:953
   with Import => True, 
        Convention => C, 
  ...
  --   token or at the terminating NUL character.   
   ...
   function getsubopt
     (uu_optionp : System.Address;
      ...
      uu_valuep : System.Address) return int  -- /usr/include/stdlib.h:964
   with Import => True, 
        Convention => C, 
  ...
  --   three, but may be less than NELEM), or -1 if an error occurred.   
   ...
   function getloadavg (uu_loadavg : access double; uu_nelem : int) return int  -- /usr/include/stdlib.h:1010
   with Import => True, 
        Convention => C, 
