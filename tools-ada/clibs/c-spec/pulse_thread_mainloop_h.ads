...
package pulse_thread_mainloop_h is
  ...
  --* An opaque threaded main loop object  
   type pa_threaded_mainloop is null record;   -- incomplete struct
  ...
  -- * running. Free with pa_threaded_mainloop_free.  
   ...
   function pa_threaded_mainloop_new return access pa_threaded_mainloop  -- /usr/include/pulse/thread-mainloop.h:253
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_new";

  --* Free a threaded main loop object. If the event loop thread is
  -- * still running, terminate it with pa_threaded_mainloop_stop()
  -- * first.  

   procedure pa_threaded_mainloop_free (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:258
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_free";

  --* Start the event loop thread. Returns zero on success, negative on error.  
   function pa_threaded_mainloop_start (m : access pa_threaded_mainloop) return int  -- /usr/include/pulse/thread-mainloop.h:261
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_start";

  --* Terminate the event loop thread cleanly. Make sure to unlock the
  -- * mainloop object before calling this function.  

   procedure pa_threaded_mainloop_stop (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:265
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_stop";
  ...
  -- * are executed with this lock held.  
   ...
   procedure pa_threaded_mainloop_lock (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:273
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_lock";

  --* Unlock the event loop object, inverse of pa_threaded_mainloop_lock().  
   procedure pa_threaded_mainloop_unlock (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:276
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_unlock";
  ...
  -- * make sure to handle that!  
   ...
   procedure pa_threaded_mainloop_wait (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:287
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_wait";
  ...
  -- * the event loop object is unlocked.  
   ...
   procedure pa_threaded_mainloop_signal (m : access pa_threaded_mainloop; wait_for_accept : int)  -- /usr/include/pulse/thread-mainloop.h:294
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_signal";
  ...
  -- * wait_for_accept value.   
   ...
   procedure pa_threaded_mainloop_accept (m : access pa_threaded_mainloop)  -- /usr/include/pulse/thread-mainloop.h:300
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_accept";

  --* Return the return value as specified with the main loop's
  -- * pa_mainloop_quit() routine.  

   function pa_threaded_mainloop_get_retval (m : access constant pa_threaded_mainloop) return int  -- /usr/include/pulse/thread-mainloop.h:304
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_get_retval";
  ...
  -- * and is destroyed when the loop is freed.  
   ...
   function pa_threaded_mainloop_get_api (m : access pa_threaded_mainloop) return access pulse_mainloop_api_h.pa_mainloop_api  -- /usr/include/pulse/thread-mainloop.h:309
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_get_api";

  --* Returns non-zero when called from within the event loop thread. \since 0.9.7  
   function pa_threaded_mainloop_in_thread (m : access pa_threaded_mainloop) return int  -- /usr/include/pulse/thread-mainloop.h:312
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_in_thread";

  --* Sets the name of the thread. \since 5.0  
   procedure pa_threaded_mainloop_set_name (m : access pa_threaded_mainloop; name : Interfaces.C.Strings.chars_ptr)  -- /usr/include/pulse/thread-mainloop.h:315
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_set_name";
  ...
  -- * in the mainloop thread context. \since 13.0  
   ...
   procedure pa_threaded_mainloop_once_unlocked
     (m : access pa_threaded_mainloop;
      callback : access procedure (arg1 : access pa_threaded_mainloop; arg2 : System.Address);
      userdata : System.Address)  -- /usr/include/pulse/thread-mainloop.h:324
   with Import => True, 
        Convention => C, 
        External_Name => "pa_threaded_mainloop_once_unlocked";

end pulse_thread_mainloop_h;
