...
package pulse_stream_h is
  ...
  --* An opaque stream for playback or recording  
   type pa_stream is null record;   -- incomplete struct

  --* A generic callback for operation completion  
   type pa_stream_success_cb_t is access procedure
        (arg1 : access pa_stream;
         arg2 : int;
         arg3 : System.Address)
   with Convention => C;  -- /usr/include/pulse/stream.h:292
  ...
  --* A generic request callback  
   type pa_stream_request_cb_t is access procedure
        (arg1 : access pa_stream;
         ...
         arg3 : System.Address)
   with Convention => C;  -- /usr/include/pulse/stream.h:295

  --* A generic notification callback  
   type pa_stream_notify_cb_t is access procedure (arg1 : access pa_stream; arg2 : System.Address)
   with Convention => C;  -- /usr/include/pulse/stream.h:298
  ...
  -- * it doesn't know. \since 0.9.15  
   ...
   type pa_stream_event_cb_t is access procedure
        (arg1 : access pa_stream;
         ...
         arg4 : System.Address)
   with Convention => C;  -- /usr/include/pulse/stream.h:306
  ...
  -- * instead and specify some initial properties.  
   ...
   function pa_stream_new
     (c : access pulse_context_h.pa_context;
      ...
      map : access constant pulse_channelmap_h.pa_channel_map) return access pa_stream  -- /usr/include/pulse/stream.h:311
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_new";
  ...
  -- * list. \since 0.9.11  
   ...
   function pa_stream_new_with_proplist
     (c : access pulse_context_h.pa_context;
      ...
      p : access pulse_proplist_h.pa_proplist) return access pa_stream  -- /usr/include/pulse/stream.h:320
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_new_with_proplist";
  ...
  -- * client must then provide. \since 1.0  
   ...
   function pa_stream_new_extended
     (c : access pulse_context_h.pa_context;
      ...
      n_formats : unsigned;
      p : access pulse_proplist_h.pa_proplist) return access pa_stream  -- /usr/include/pulse/stream.h:331
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_new_extended";
  ...
  --* Decrease the reference counter by one.  
   procedure pa_stream_unref (s : access pa_stream)  -- /usr/include/pulse/stream.h:339
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_unref";

  --* Increase the reference counter by one.  
   function pa_stream_ref (s : access pa_stream) return access pa_stream  -- /usr/include/pulse/stream.h:342
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_ref";

  --* Return the current state of the stream.  
   function pa_stream_get_state (p : access constant pa_stream) return pulse_def_h.pa_stream_state_t  -- /usr/include/pulse/stream.h:345
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_state";

  --* Return the context this stream is attached to.  
   function pa_stream_get_context (p : access constant pa_stream) return access pulse_context_h.pa_context  -- /usr/include/pulse/stream.h:348
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_context";
  ...
  -- * on failure.  
   ...
   function pa_stream_get_index (s : access constant pa_stream) return bits_stdint_uintn_h.uint32_t  -- /usr/include/pulse/stream.h:355
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_index";
  ...
  -- * including the being server older than 0.9.8. \since 0.9.8  
   ...
   function pa_stream_get_device_index (s : access constant pa_stream) return bits_stdint_uintn_h.uint32_t  -- /usr/include/pulse/stream.h:366
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_device_index";
  ...
  -- * 0.9.8. \since 0.9.8  
   ...
   function pa_stream_get_device_name (s : access constant pa_stream) return Interfaces.C.Strings.chars_ptr  -- /usr/include/pulse/stream.h:377
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_device_name";
  ...
  -- * server is older than 0.9.8. \since 0.9.8  
   ...
   function pa_stream_is_suspended (s : access constant pa_stream) return int  -- /usr/include/pulse/stream.h:383
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_is_suspended";

  --* Return 1 if the this stream has been corked. This will return 0 if
  -- * not, and a negative value on error. \since 0.9.11  

   function pa_stream_is_corked (s : access constant pa_stream) return int  -- /usr/include/pulse/stream.h:387
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_is_corked";
  ...
  -- * Returns zero on success.  
   ...
   function pa_stream_connect_playback
     (s : access pa_stream;
      ...
      flags : pulse_def_h.pa_stream_flags_t;
      volume : access constant pulse_volume_h.pa_cvolume;
      sync_stream : access pa_stream) return int  -- /usr/include/pulse/stream.h:415
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_connect_playback";
  ...
  --* Connect the stream to a source. Returns zero on success.  
   function pa_stream_connect_record
     (s : access pa_stream;
      dev : Interfaces.C.Strings.chars_ptr;
      attr : access constant pulse_def_h.pa_buffer_attr;
      flags : pulse_def_h.pa_stream_flags_t) return int  -- /usr/include/pulse/stream.h:424
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_connect_record";
  ...
  --* Disconnect a stream from a source/sink. Returns zero on success.  
   function pa_stream_disconnect (s : access pa_stream) return int  -- /usr/include/pulse/stream.h:431
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_disconnect";
  ...
  -- * \since 0.9.16  
   ...
   function pa_stream_begin_write
     (p : access pa_stream;
      data : System.Address;
      nbytes : access stddef_h.size_t) return int  -- /usr/include/pulse/stream.h:472
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_begin_write";
  ...
  -- * Returns zero on success. \since 0.9.16  
   ...
   function pa_stream_cancel_write (p : access pa_stream) return int  -- /usr/include/pulse/stream.h:486
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_cancel_write";
  ...
  -- * Returns zero on success.  
   ...
   function pa_stream_write
     (p : access pa_stream;
      ...
      free_cb : pulse_def_h.pa_free_cb_t;
      offset : bits_stdint_intn_h.int64_t;
      seek : pulse_def_h.pa_seek_mode_t) return int  -- /usr/include/pulse/stream.h:513
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_write";
  ...
  -- *  that free_cb_data is passed to free_cb instead of data. \since 6.0  
   ...
   function pa_stream_write_ext_free
     (p : access pa_stream;
      data : System.Address;
      nbytes : stddef_h.size_t;
      free_cb : pulse_def_h.pa_free_cb_t;
      free_cb_data : System.Address;
      offset : bits_stdint_intn_h.int64_t;
      seek : pulse_def_h.pa_seek_mode_t) return int  -- /usr/include/pulse/stream.h:523
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_write_ext_free";
  ...
  -- * Returns zero on success, negative on error.  
   ...
   function pa_stream_peek
     (p : access pa_stream;
      data : System.Address;
      nbytes : access stddef_h.size_t) return int  -- /usr/include/pulse/stream.h:550
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_peek";
  ...
  -- * calling pa_stream_peek(). Returns zero on success.  
   ...
   function pa_stream_drop (p : access pa_stream) return int  -- /usr/include/pulse/stream.h:557
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_drop";
  ...
  --  
   ...
   function pa_stream_writable_size (p : access constant pa_stream) return stddef_h.size_t  -- /usr/include/pulse/stream.h:569
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_writable_size";

  --* Return the number of bytes that may be read using pa_stream_peek().
  -- *
  -- * (size_t) -1 is returned on error.  

   function pa_stream_readable_size (p : access constant pa_stream) return stddef_h.size_t  -- /usr/include/pulse/stream.h:574
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_readable_size";
  ...
  -- * at a time.  
   ...
   function pa_stream_drain
     (s : access pa_stream;
      ...
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:580
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_drain";
  ...
  -- * up values.  
   ...
   function pa_stream_update_timing_info
     (p : access pa_stream;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:586
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_update_timing_info";

  --* Set the callback function that is called whenever the state of the stream changes.  
   procedure pa_stream_set_state_callback
     (s : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:589
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_state_callback";
  ...
  -- * written to the stream.  
   ...
   procedure pa_stream_set_write_callback
     (p : access pa_stream;
      ...
      userdata : System.Address)  -- /usr/include/pulse/stream.h:593
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_write_callback";

  --* Set the callback function that is called when new data is available from the stream.  
   procedure pa_stream_set_read_callback
     (p : access pa_stream;
      cb : pa_stream_request_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:596
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_read_callback";
  ...
  --* Set the callback function that is called when a buffer overflow happens. (Only for playback streams)  
   ...
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_overflow_callback";
  ...
  -- * (Only for playback streams) \since 1.0  
   ...
   function pa_stream_get_underflow_index (p : access constant pa_stream) return bits_stdint_intn_h.int64_t  -- /usr/include/pulse/stream.h:605
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_underflow_index";
  ...
  --* Set the callback function that is called when a buffer underflow happens. (Only for playback streams)  
   procedure pa_stream_set_underflow_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:608
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_underflow_callback";
  ...
  -- * 0.9.11  
   ...
   procedure pa_stream_set_started_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:615
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_started_callback";
  ...
  -- * streams only.  
   ...
   procedure pa_stream_set_latency_update_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:620
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_latency_update_callback";
  ...
  -- * 0.9.8. \since 0.9.8  
   ...
   procedure pa_stream_set_moved_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:627
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_moved_callback";
  ...
  -- * 0.9.8. \since 0.9.8  
   ...
   procedure pa_stream_set_suspended_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:637
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_suspended_callback";
  ...
  -- * control event is received. \since 0.9.15  
   ...
   procedure pa_stream_set_event_callback
     (p : access pa_stream;
      ...
      userdata : System.Address)  -- /usr/include/pulse/stream.h:641
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_event_callback";
  ...
  -- * pa_stream_set_moved_callback() as well. \since 0.9.15  
   ...
   procedure pa_stream_set_buffer_attr_callback
     (p : access pa_stream;
      cb : pa_stream_notify_cb_t;
      userdata : System.Address)  -- /usr/include/pulse/stream.h:648
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_buffer_attr_callback";
  ...
  -- * the stream, it will be created in corked state.  
   ...
   function pa_stream_cork
     (s : access pa_stream;
      b : int;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:660
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_cork";
  ...
  -- * \a seek of pa_stream_write() instead of this function.  
   ...
   function pa_stream_flush
     (s : access pa_stream;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:665
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_flush";
  ...
  -- * structure. Available for playback streams only.  
   ...
   function pa_stream_prebuf
     (s : access pa_stream;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:669
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_prebuf";
  ...
  -- * Available for playback streams only.  
   ...
   function pa_stream_trigger
     (s : access pa_stream;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:674
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_trigger";
  ...
  --* Rename the stream.  
   function pa_stream_set_name
     (s : access pa_stream;
      name : Interfaces.C.Strings.chars_ptr;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:677
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_name";
  ...
  -- * Returns zero on success, negative on error.  
   ...
   function pa_stream_get_time (s : access pa_stream; r_usec : access pulse_sample_h.pa_usec_t) return int  -- /usr/include/pulse/stream.h:714
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_time";
  ...
  -- * pa_stream_get_time().  
   ...
   function pa_stream_get_latency
     (s : access pa_stream;
      r_usec : access pulse_sample_h.pa_usec_t;
      negative : access int) return int  -- /usr/include/pulse/stream.h:730
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_latency";
  ...
  -- * update has been received.  
   ...
   function pa_stream_get_timing_info (s : access pa_stream) return access constant pulse_def_h.pa_timing_info  -- /usr/include/pulse/stream.h:745
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_timing_info";

  --* Return a pointer to the stream's sample specification.  
   function pa_stream_get_sample_spec (s : access pa_stream) return access constant pulse_sample_h.pa_sample_spec  -- /usr/include/pulse/stream.h:748
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_sample_spec";

  --* Return a pointer to the stream's channel map.  
   function pa_stream_get_channel_map (s : access pa_stream) return access constant pulse_channelmap_h.pa_channel_map  -- /usr/include/pulse/stream.h:751
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_channel_map";

  --* Return a pointer to the stream's format. \since 1.0  
   function pa_stream_get_format_info (s : access constant pa_stream) return access constant pulse_format_h.pa_format_info  -- /usr/include/pulse/stream.h:754
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_format_info";
  ...
  -- * PA_STREAM_ADJUST_LATENCY is set or not. \since 0.9.0  
   ...
   function pa_stream_get_buffer_attr (s : access pa_stream) return access constant pulse_def_h.pa_buffer_attr  -- /usr/include/pulse/stream.h:764
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_buffer_attr";
  ...
  -- * PA_STREAM_ADJUST_LATENCY is set or not. \since 0.9.8  
   ...
   function pa_stream_set_buffer_attr
     (s : access pa_stream;
      attr : access constant pulse_def_h.pa_buffer_attr;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:774
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_buffer_attr";
  ...
  -- * is at least PulseAudio 0.9.8. \since 0.9.8  
   ...
   function pa_stream_update_sample_rate
     (s : access pa_stream;
      rate : bits_stdint_uintn_h.uint32_t;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:781
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_update_sample_rate";
  ...
  -- * this stream to the right device. \since 0.9.11  
   ...
   function pa_stream_proplist_update
     (s : access pa_stream;
      ...
      p : access pulse_proplist_h.pa_proplist;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:789
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_proplist_update";
  ...
  -- * stream, remove entries. \since 0.9.11  
   ...
   function pa_stream_proplist_remove
     (s : access pa_stream;
      keys : System.Address;
      cb : pa_stream_success_cb_t;
      userdata : System.Address) return access pulse_operation_h.pa_operation  -- /usr/include/pulse/stream.h:793
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_proplist_remove";
  ...
  -- * Returns zero on success, negative on error. \since 0.9.11  
   ...
   function pa_stream_set_monitor_stream (s : access pa_stream; sink_input_idx : bits_stdint_uintn_h.uint32_t) return int  -- /usr/include/pulse/stream.h:799
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_set_monitor_stream";
  ...
  -- * on failure. \since 0.9.11  
   ...
   function pa_stream_get_monitor_stream (s : access constant pa_stream) return bits_stdint_uintn_h.uint32_t  -- /usr/include/pulse/stream.h:804
   with Import => True, 
        Convention => C, 
        External_Name => "pa_stream_get_monitor_stream";
