...
package bits_pthreadtypes_h is
  ...
  --   type is not exposed on purpose.   
   ...
   subtype pthread_mutexattr_t_array974 is Interfaces.C.char_array (0 .. 3);
   type pthread_mutexattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased pthread_mutexattr_t_array974;  -- /usr/include/bits/pthreadtypes.h:34
         when others =>
  ...
  --   the attribute type is not exposed on purpose.   
   ...
   subtype pthread_condattr_t_array974 is Interfaces.C.char_array (0 .. 3);
   type pthread_condattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased pthread_condattr_t_array974;  -- /usr/include/bits/pthreadtypes.h:43
         when others =>
  ...
  -- Once-only execution  
   ...
   subtype anon980_array982 is Interfaces.C.char_array (0 .. 55);
   type pthread_attr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon980_array982;  -- /usr/include/bits/pthreadtypes.h:58
         when others =>
   ...
   subtype pthread_mutex_t_array986 is Interfaces.C.char_array (0 .. 39);
   type pthread_mutex_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased pthread_mutex_t_array986;  -- /usr/include/bits/pthreadtypes.h:70
         when others =>
   ...
   subtype pthread_cond_t_array990 is Interfaces.C.char_array (0 .. 47);
   type pthread_cond_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased pthread_cond_t_array990;  -- /usr/include/bits/pthreadtypes.h:78
         when others =>
  ...
  --   structure of the attribute type is deliberately not exposed.   
   ...
   subtype pthread_rwlock_t_array982 is Interfaces.C.char_array (0 .. 55);
   type pthread_rwlock_t (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_size : aliased pthread_rwlock_t_array982;  -- /usr/include/bits/pthreadtypes.h:89
         when others =>
   ...
   subtype pthread_rwlockattr_t_array996 is Interfaces.C.char_array (0 .. 7);
   type pthread_rwlockattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased pthread_rwlockattr_t_array996;  -- /usr/include/bits/pthreadtypes.h:95
         when others =>
  ...
  --   deliberately not exposed.   
   ...
   subtype pthread_barrier_t_array1002 is Interfaces.C.char_array (0 .. 31);
   type pthread_barrier_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased pthread_barrier_t_array1002;  -- /usr/include/bits/pthreadtypes.h:110
         when others =>
   ...
   subtype pthread_barrierattr_t_array974 is Interfaces.C.char_array (0 .. 3);
   type pthread_barrierattr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased pthread_barrierattr_t_array974;  -- /usr/include/bits/pthreadtypes.h:116
         when others =>
