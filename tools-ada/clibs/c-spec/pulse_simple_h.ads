...
package pulse_simple_h is
  ...
  --* Create a new connection to the server.  
   function pa_simple_new
     (server : Interfaces.C.Strings.chars_ptr;
      ...
      error : access int) return access pa_simple  -- /usr/include/pulse/simple.h:118
   with Import => True, 
        Convention => C, 
  ...
  --* Close and free the connection to the server. The connection object becomes invalid when this is called.  
   procedure pa_simple_free (s : access pa_simple)  -- /usr/include/pulse/simple.h:131
   with Import => True, 
        Convention => C, 
  ...
  --* Write some data to the server. Returns zero on success, negative on error.  
   function pa_simple_write
     (s : access pa_simple;
      ...
      error : access int) return int  -- /usr/include/pulse/simple.h:134
   with Import => True, 
        Convention => C, 
  ...
  -- * Returns zero on success, negative on error.  
   ...
   function pa_simple_drain (s : access pa_simple; error : access int) return int  -- /usr/include/pulse/simple.h:138
   with Import => True, 
        Convention => C, 
        External_Name => "pa_simple_drain";
  ...
  -- * Returns zero on success, negative on failure.  
   ...
   function pa_simple_read
     (s : access pa_simple;
      data : System.Address;
      bytes : stddef_h.size_t;
      error : access int) return int  -- /usr/include/pulse/simple.h:143
   with Import => True, 
        Convention => C, 
        External_Name => "pa_simple_read";
  ...
  --* Return the playback or record latency.  
   function pa_simple_get_latency (s : access pa_simple; error : access int) return pulse_sample_h.pa_usec_t  -- /usr/include/pulse/simple.h:153
   with Import => True, 
        Convention => C, 
        External_Name => "pa_simple_get_latency";
