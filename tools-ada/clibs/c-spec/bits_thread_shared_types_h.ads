...
package bits_thread_shared_types_h is
  ...
  -- Common definition of pthread_cond_t.  
   type anon961_struct963 is record
   ...
   type anon961_union962 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_wseq : aliased Extensions.unsigned_long_long;  -- /usr/include/bits/thread-shared-types.h:96
         when others =>
            uu_wseq32 : aliased anon961_struct963;  -- /usr/include/bits/thread-shared-types.h:101
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon961_struct965 is record
   ...
   with Convention => C_Pass_By_Copy;
   type anon961_union964 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_g1_start : aliased Extensions.unsigned_long_long;  -- /usr/include/bits/thread-shared-types.h:105
         when others =>
            uu_g1_start32 : aliased anon961_struct965;  -- /usr/include/bits/thread-shared-types.h:110
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon961_array966 is array (0 .. 1) of aliased unsigned;
   type uu_pthread_cond_s is record
      anon2120 : aliased anon961_union962;  -- /usr/include/bits/thread-shared-types.h:102
      anon2127 : aliased anon961_union964;  -- /usr/include/bits/thread-shared-types.h:111
      uu_g_refs : aliased anon961_array966;  -- /usr/include/bits/thread-shared-types.h:112
      uu_g_size : aliased anon961_array966;  -- /usr/include/bits/thread-shared-types.h:113
      ...
      uu_g_signals : aliased anon961_array966;  -- /usr/include/bits/thread-shared-types.h:116
   end record
